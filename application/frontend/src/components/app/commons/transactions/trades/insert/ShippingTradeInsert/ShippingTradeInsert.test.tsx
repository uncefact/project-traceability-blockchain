...
import STI, {ShippingTradeInsert} from "./ShippingTradeInsert";
...
isInvitation={isInvitation}
    ...
    it('Content test - shipping', async () => {
        const mockedRegister = jest.fn();
        const mockedHandleSubmit = jest.fn();
        // @ts-ignore
        const mockedErrors = [];
...
isInvitation={isInvitation}
        ...
        expect(MockedFormLabel).toHaveBeenNthCalledWith(3, {children: "trade.shipment_type"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(4, {children: "attachment"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(5, {children: "shipping_date"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(6, {children: "reference_standard"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(7, {children: "trade.shipment_id"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(8, {children: "trade.shipment_root_id"}, {});
        ...
        expect(component.find('h2').at(0).text()).toEqual("transaction: shipment");
...
isInvitation={isInvitation}
    ...
    it('addMaterial test', async () => {
        ...
        let component;
        await act(async () => {
            component = mount(<ShippingTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
                addMaterial={addMaterial}
                getAllUnits={getAllUnits}
...
isInvitation={isInvitation}
    ...
    it('consigneeEmail selected test', async () => {
        ...
        let component;
        await act(async () => {
            component = await mount(<ShippingTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
                addMaterial={addMaterial}
                getAllUnits={getAllUnits}
...
isInvitation={isInvitation}
    ...
    it('handleTransaction test', async () => {
        ...
        MockedTradeControllerApi.createShipping.mockImplementation(() => Promise.resolve(trade));
        await act(async () => {
            component = mount(<ShippingTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
...
isInvitation={isInvitation}
        ...
        await handleSubmit.mock.calls[2][0](shippingRequest);

        expect(addSuccessMessage).toHaveBeenCalledTimes(1);
        expect(addSuccessMessage).toHaveBeenNthCalledWith(1, "popups.success.shipping_create");
...
isInvitation={isInvitation}
    ...
    it('handleTransaction test - failed', async () => {
        ...
        let component;
        MockedTradeControllerApi.createShipping.mockImplementation(() => Promise.reject("Generic Error"));
        await act(async () => {
            component = await mount(<ShippingTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
...
describe("Graphical behaviour tests", () => {
    ...
    it('Add positions', async () => {
        ...
        const positions: Position[] = [{id: 0, material: undefined, unit: undefined}, {id: 1, material: undefined, unit: undefined}];
...
isInvitation={isInvitation}
        ...
        expect(Form.Label).toHaveBeenNthCalledWith(10, {children: "material"}, {});
        expect(Form.Label).toHaveBeenNthCalledWith(12, {children: "positions.unit"}, {});
        expect(Form.Label).toHaveBeenNthCalledWith(15, {children: "material"}, {});
        expect(Form.Label).toHaveBeenNthCalledWith(17, {children: "positions.unit"}, {});
...
isInvitation={isInvitation}
        ...
        expect(MockedSelect).toHaveBeenCalledTimes(8);
        expect(MockedSelect.mock.calls[6][0].options).toEqual(docTypes.map(d => ({value: d, label: d.code + " - " + d.name})));
...
isInvitation={isInvitation}
        ...
        if (component) {
            ...
            expect(MockedSelect).toHaveBeenCalledTimes(4);
            expect(MockedSelect.mock.calls[3][0].options).toEqual(allProcessingStandards.map(ps => ({value: ps, label: ps.name})));
        }
    });
