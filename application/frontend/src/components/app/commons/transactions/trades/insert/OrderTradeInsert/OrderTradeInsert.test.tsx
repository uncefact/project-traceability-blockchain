...
import {
    CompanyPresentable, DocumentRequest, DocumentTypePresentable,
    ProcessingStandard,
    TradePresentable,
    Unit,
    UserPresentable
...
import OTI, {OrderTradeInsert} from "./OrderTradeInsert";
...
describe('Order insertion test', () => {
    ...
    it('Content test - order', async () => {
        ...
        expect(MockedFormLabel).toHaveBeenCalledTimes(15);
        ...
        expect(MockedFormLabel).toHaveBeenNthCalledWith(3, {children: "trade.order_type"}, {});
        ...
        expect(MockedFormLabel).toHaveBeenNthCalledWith(8, {children: "trade.order_id"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(9, {children: "trade.order_root_id"}, {});
        ...
        expect(MockedFormLabel).toHaveBeenNthCalledWith(12, {children: "positions.quantity"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(13, {children: "positions.unit"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(14, {children: "positions.weight"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(15, {children: "positions.material_description"}, {});

        expect(component.find('h2').length).toEqual(2);
        expect(component.find('h2').at(0).text()).toEqual("transaction: order");
    ...
    it('Document upload test', async () => {
        ...
        expect(Form.Group).toHaveBeenCalledTimes(15);
        expect(Form.Label).toHaveBeenCalledTimes(15);
    ...
    it('Content test - add positions', async () => {
        ...
        expect(Form.Group).toHaveBeenCalledTimes(15);
        expect(Form.Label).toHaveBeenNthCalledWith(11, {children: "material"}, {});
    ...
    it('addMaterial test', async () => {
        ...
        let component;
        await act(async () => {
            component = mount(<OrderTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
                addMaterial={addMaterial}
                getAllUnits={getAllUnits}
    ...
    it('consigneeEmail selected test', async () => {
        ...
        let component;
        await act(async () => {
            component = await mount(<OrderTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
                addMaterial={addMaterial}
                getAllUnits={getAllUnits}
    ...
    it('handleTransaction test', async () => {
        ...
        const trade: TradePresentable = {
            contractorReferenceNumber: "431GL",
        }

        MockedTradeControllerApi.createOrder.mockImplementation(() => Promise.resolve(trade));
        await act(async () => {
            component = mount(<OrderTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
        ...
        await handleSubmit.mock.calls[2][0](orderRequest);

        expect(addSuccessMessage).toHaveBeenCalledTimes(1);
        expect(addSuccessMessage).toHaveBeenNthCalledWith(1, "popups.success.order_create");
    ...
    it('handleTransaction test - failed', async () => {
        ...
        let component;
        MockedTradeControllerApi.createOrder.mockImplementation(() => Promise.reject("Generic Error"));
        await act(async () => {
            component = await mount(<OrderTradeInsert
                getCompanyTraders={getCompanies}
                getMaterialsByCompany={getMaterialsFromCompany}
...
describe("Graphical behaviour tests", () => {
    const MockedUseForm = mocked(useForm, true);
    const MockedButton = mocked(Button, true);
    const MockedGenericDropdownSelector = mocked(GenericDropdownSelector, true);
    const MockedSelect = mocked(Select, true);
    ...
    it('Add positions', async () => {
        ...
        expect(Form.Group).toHaveBeenCalledTimes(20);
        expect(Form.Label).toHaveBeenNthCalledWith(11, {children: "material"}, {});
        expect(Form.Label).toHaveBeenNthCalledWith(13, {children: "positions.unit"}, {});
        expect(Form.Label).toHaveBeenNthCalledWith(16, {children: "material"}, {});
        expect(Form.Label).toHaveBeenNthCalledWith(18, {children: "positions.unit"}, {});

    });

    it('Content test - getAllDocumentTypes option select', async () => {
        const mockedRegister = jest.fn();
        const mockedHandleSubmit = jest.fn();
        // @ts-ignore
        const mockedErrors = [];
        ...
        // @ts-ignore
        expect(component.find('.FormControl').length).toEqual(9);
        expect(MockedSelect).toHaveBeenCalledTimes(8);
    ...
    it('Content test - getAllUnits option select', async () => {
        ...
        expect(component.find('.FormControl').length).toEqual(9);
        // @ts-ignore
        expect(component.find('.FormControl').at(6).find('option').length).toEqual(4);
        // @ts-ignore
        expect(component.find('.FormControl').at(6).find('option').at(1).html()).toEqual("<option value=\"123\">123 - kg</option>")
        // @ts-ignore
        expect(component.find('.FormControl').at(6).find('option').at(2).html()).toEqual("<option value=\"132\">132 - ml</option>")
        // @ts-ignore
        expect(component.find('.FormControl').at(6).find('option').at(3).html()).toEqual("<option value=\"321\">321 - mm</option>")
    });
    ...
    it('Content test - getCompanies option select', async () => {
        ...
        expect(component.find('.FormControl').length).toEqual(9);
        expect(MockedSelect).toHaveBeenCalledTimes(4);
        expect(MockedSelect.mock.calls[0][0].options).toEqual(companies.map(c => ({value: c, label: c.companyName})));
    });
