...
import {SelfCertificationView} from "./SelfCertificationView";
...
describe('Self certification view test', () => {
    // @ts-ignore
    ...
    it('Document preview - generic', async () => {
        ...
        await act(async () => {
            component = await mount(<SelfCertificationView
                blockchainVerification={blockchainVerification}
                certification={certification}
                documentBlockchainVerified={documentBlockchainVerified}
                addSuccessMessage={addSuccessMessage} addErrorMessage={addErrorMessage}/>);
