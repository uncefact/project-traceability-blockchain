...
export const SelfCertificationView = (props: Props) => {
    ...
    return (
        <Jumbotron className={styles.Container}>
            <h2>{t("certification.self_title")}</h2>
            <Form className={styles.Form}>
                ...
                <Form.Group className={styles.CertificationProcessingStandardArea}>
                    ...
                    <Form.Control type="text" value={props.certification?.processingStandardName} placeholder={t("placeholders.certification.no_proprietary_standard")} disabled/>
                </Form.Group>
                ...
                <Form.Group className={styles.Material}>
...
export default connector(SelfCertificationView);
