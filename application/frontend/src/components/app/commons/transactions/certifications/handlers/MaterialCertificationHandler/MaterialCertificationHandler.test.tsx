...
import MCH, {MaterialCertificationHandler} from "./MaterialCertificationHandler";
...
describe('Material certification handler test', () => {
    ...
    it('Content test', async () => {
        ...
        await act(async () => {
            component = await mount(<MaterialCertificationHandler
                addErrorMessage={addErrorMessage} addSuccessMessage={addSuccessMessage}
                startLoading={startLoading} stopLoading={stopLoading}
                userLoggedIn={userLoggedIn} />
            )});
        ...
        await act(async () => {
            await mount(<MaterialCertificationHandler
                addErrorMessage={addErrorMessage} addSuccessMessage={addSuccessMessage}
                startLoading={startLoading} stopLoading={stopLoading}
                userLoggedIn={userLoggedIn} />
            )});
        ...
        MockedCertificationControllerApi.getCertification.mockReturnValue(Promise.resolve(certificationRetrieved));
        await act(async () => {
            mount(<MaterialCertificationHandler
                addErrorMessage={addErrorMessage} addSuccessMessage={addSuccessMessage}
                startLoading={startLoading} stopLoading={stopLoading}
                userLoggedIn={userLoggedIn} />
            )});
    ...
    it('Certification loading failed', async () => {
        ...
        expect(addErrorMessage).toHaveBeenNthCalledWith(1, "popups.errors.material_certification: Generic error");
    });
