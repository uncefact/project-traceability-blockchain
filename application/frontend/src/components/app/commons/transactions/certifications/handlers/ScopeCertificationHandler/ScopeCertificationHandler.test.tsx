...
import SCH, {ScopeCertificationHandler} from "./ScopeCertificationHandler";
...
describe('Scope certification handler test', () => {
    ...
    it('Content test', async () => {
        ...
        await act(async () => {
            component = await mount(<ScopeCertificationHandler
                addErrorMessage={addErrorMessage} addSuccessMessage={addSuccessMessage}
                startLoading={startLoading} stopLoading={stopLoading}
                userLoggedIn={userLoggedIn} />
            )});
        ...
        await act(async () => {
            await mount(<ScopeCertificationHandler
                addErrorMessage={addErrorMessage} addSuccessMessage={addSuccessMessage}
                startLoading={startLoading} stopLoading={stopLoading}
                userLoggedIn={userLoggedIn} />
            )});
        ...
        MockedCertificationControllerApi.getCertification.mockReturnValue(Promise.resolve(certificationRetrieved));
        await act(async () => {
            mount(<ScopeCertificationHandler
                addErrorMessage={addErrorMessage} addSuccessMessage={addSuccessMessage}
                startLoading={startLoading} stopLoading={stopLoading}
                userLoggedIn={userLoggedIn} />
            )});
    ...
    it('Certification loading failed', async () => {
        ...
        expect(addErrorMessage).toHaveBeenNthCalledWith(1, "popups.errors.scope_certification: Generic error");
    });
