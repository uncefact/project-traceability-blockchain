...
import {SelfCertificationConfirm} from "./SelfCertificationConfirm";
...
describe('Self certification confirmation test', () => {
    // @ts-ignore
    ...
    it('Content test', async () => {
        ...
        expect(MockedFormGroup).toHaveBeenCalledTimes(13);
        ...
        expect(MockedFormLabel).toHaveBeenNthCalledWith(9, {children: "valid_from"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(10, {children: "valid_until"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(11, {children: "certification.report_id"}, {});
        expect(MockedFormLabel).toHaveBeenNthCalledWith(12, {children: "material"}, {});
    ...
    it('Document preview - generic', async () => {
        ...
        await act(async () => {
            component = await mount(<SelfCertificationConfirm
                blockchainVerification={blockchainVerification}
                certification={certification}
                documentBlockchainVerified={documentBlockchainVerified}
                addSuccessMessage={addSuccessMessage} addErrorMessage={addErrorMessage}/>);
    ...
    it('handleConfirmation success', async () => {
        ...
        expect(addSuccessMessage).toHaveBeenNthCalledWith(1, "popups.success.self_cert_add");
