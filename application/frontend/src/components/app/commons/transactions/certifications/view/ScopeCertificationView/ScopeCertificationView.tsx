...
export const ScopeCertificationView = (props: Props) => {
    ...
    return (
        <Jumbotron className={styles.Container}>
            <h2>{t("certification.scope_title")}</h2>
            <Form className={styles.Form}>
                ...
                <Form.Group className={styles.ConsigneeRefNumberArea}>
                    ...
                    <Form.Control name="certificateReferenceNumber" type="text"
                                  placeholder={t("placeholders.not_specified")}
                                  value={props.certification?.certificateReferenceNumber} disabled/>
                </Form.Group>
            </Form>
        </Jumbotron>
    );
...
export default connector(ScopeCertificationView);
